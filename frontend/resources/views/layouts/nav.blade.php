<nav class="border-b border-gray-800">
    ...
    <div class="container mx-15 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <li class="md:ml-6 md:mt-0">
                <form action="/session" method="POST" class="mt-4">
                    ...
                    <button type="submit" id="checkout-live-button"
                        class="hover:text-yellow-300 transition-ease-in-out duration-150">Upgrade to
                        Pro++
                    </button>
                </form>
