    ...
    <section class="bg-gray-50 min-h-screen flex items-center justify-center">
        ...
        <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
            ...
            <div class="md:w-1/2 px-8 md:px-16">
                ...
                <p class="text-xs mt-4 text-[#002D74]">New to Flex? Please Register to continue.</p>

                <form action="" method="POST" class="flex flex-col gap-4">
                    @csrf
                    <input class="p-2 mt-8 rounded-xl border text-black" type="text" name="name" placeholder="Name">
                    <input class="p-2 rounded-xl border text-black" type="email" name="email" placeholder="Email">
            ...
            <div class="md:block hidden w-1/2">
                <img class="rounded-2xl lg:h-[650px]"
